...
LONG_PROMPT_PAIRS = [
    ...
    {
        "prompt": "描述量子计算的基本原理。",
        "context": "量子计算是一种利用量子力学现象（如叠加和纠缠）来执行计算的技术。传统计算机使用位作为信息的基本单位，每个位可以是0或1。相比之下，量子计算机使用量子比特或'量子位'，它们可以同时处于0和1的叠加状态。这种特性使量子计算机能够并行处理大量可能的计算路径，理论上可以解决某些传统计算机难以解决的问题。量子计算的应用包括密码学、药物发现、优化问题和材料科学等领域。尽管量子计算有巨大潜力，但它仍面临着量子退相干和错误校正等技术挑战。"
    },
    {
        "prompt": "人工智能如何改变医疗行业？",
        "context": "人工智能正在深刻改变医疗行业，提高诊断准确性、治疗效果和患者护理。在诊断方面，AI算法能够分析医学图像（如X光片、CT扫描和MRI），有时比人类医生更快、更准确地识别疾病模式。预测分析工具利用患者数据预测健康风险和疾病进展，使医疗专业人员能够采取预防措施。在药物发现中，AI加速了新药的开发过程，分析大量化合物数据以识别潜在的治疗方法。机器人辅助手术提高了精确度和减少了恢复时间。虚拟健康助手和聊天机器人改善了患者参与度和初级护理的可及性。尽管AI在医疗中有巨大潜力，但仍存在数据隐私、算法偏见和监管挑战等问题需要解决。"
    },
    {
        "prompt": "全球变暖的主要影响是什么？",
        "context": "全球变暖正在对地球的物理、生物和人类系统产生广泛的影响。气温上升导致极端天气事件更加频繁和严重，包括热浪、干旱、野火和强烈风暴。冰川和极地冰盖的融化正在导致海平面上升，威胁着沿海社区和低洼岛屿。海洋酸化和珊瑚白化正在破坏海洋生态系统。陆地上，物种正在改变其地理分布，有些面临灭绝风险，因为它们无法适应变化的条件。对人类社会而言，全球变暖威胁着粮食和水安全，加剧了健康风险，如热相关疾病和传染病的传播范围扩大。气候变化还可能加剧社会不平等和引发大规模移民，因为人们逃离受影响最严重的地区。"
    },
    {
        "prompt": "可再生能源与化石燃料的区别是什么？",
        "context": "可再生能源和化石燃料在来源、环境影响和可持续性方面有根本区别。可再生能源来自自然过程中不断补充的来源，如阳光、风、水流、地热热量和生物质。相比之下，化石燃料（煤炭、石油和天然气）是从地下提取的有限资源，形成于数百万年前的古代植物和生物残骸。环境影响方面，可再生能源通常产生很少或没有温室气体排放，而化石燃料燃烧是气候变化的主要贡献者。可再生能源技术的初始安装成本可能较高，但运营成本通常较低，而且随着技术进步，成本持续下降。化石燃料的提取和使用可能导致空气和水污染、栖息地破坏和公共健康问题。从长远来看，可再生能源提供了一条更可持续的能源路径，而化石燃料最终将耗尽。"
    },
    {
        "prompt": "健康饮食的基本原则是什么？",
        "context": "健康饮食的基本原则围绕着平衡、多样性和适度。均衡的饮食应包括所有主要食物组的适当比例：水果和蔬菜、全谷物、蛋白质来源和健康脂肪。多样性确保摄入广泛的营养素，包括必需维生素、矿物质和抗氧化剂。适量控制总热量摄入对维持健康体重至关重要。减少加工食品、添加糖、反式脂肪和过量钠的摄入可以降低慢性疾病风险。增加膳食纤维摄入支持消化健康，而充足的水分摄入对整体健康至关重要。重要的是要认识到个体差异，如年龄、性别、活动水平和健康状况会影响特定的营养需求。可持续的饮食模式，如地中海饮食，强调以植物为基础的食物、适量的鱼类和减少红肉，已被证明对长期健康有益。"
    },
    {
        "prompt": "心理健康的重要性是什么？",
        "context": "心理健康是整体健康的基本组成部分，与身体健康同等重要。良好的心理健康使个体能够应对生活的正常压力、发挥生产力、实现潜力并为社区做出贡献。它影响我们的思考、感受和行为方式，塑造我们如何做决定、处理压力和与他人互动。心理健康问题，如抑郁症和焦虑症，可以显著影响日常功能、人际关系和生活质量。它们还可能导致或加剧身体健康问题，如心脏病、中风和糖尿病。尽管心理健康问题很常见，影响全球近10亿人，但污名和误解仍然阻碍许多人寻求帮助。早期干预和适当治疗可以有效管理大多数心理健康状况。促进心理健康的策略包括培养社会联系、保持身体活动、发展应对技能、获得充足睡眠和寻求专业支持。"
    },
    {
    ...
    },
    {
        ...
        "context": "基因编辑技术，特别是CRISPR-Cas9，正在彻底改变我们操纵DNA的能力，开辟了广泛的潜在应用。在医学领域，基因编辑有望治疗遗传疾病，如囊性纤维化、镰状细胞贫血和亨廷顿舞蹈症，通过直接修正导致这些疾病的基因突变。它还在癌症研究中显示出前景，使科学家能够设计免疫细胞更有效地靶向肿瘤。在农业中，基因编辑可以开发抗病、抗旱和营养价值更高的作物品种，潜在地提高粮食安全和可持续性。在生物技术领域，它使研究人员能够设计微生物生产药物、生物燃料和其他有价值的化合物。尽管基因编辑有巨大潜力，但它也引发了伦理问题，特别是关于人类胚胎编辑、基因驱动生物体的环境影响以及获取这些技术的公平性问题。"
    },
    {
